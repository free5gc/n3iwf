...
func SendNGReset(
	...
	isNGResetSent := false
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.NG_SETUP_RESPONSE, &isNGResetSent, cause, &additionalCause)
	ngapLog := logger.NgapLog
...
func SendNGResetAcknowledge(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.NG_RESET_ACKNOWLEDGE, &isNGResetAckSent, emptyCause, &additionalCause)
...
func SendInitialContextSetupResponse(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.INITIAL_CONTEXT_SETUP_RESPONSE, &isInitialCtxRespSent, emptyCause, &additionalCause)
...
func SendInitialContextSetupFailure(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.INITIAL_CONTEXT_SETUP_RESPONSE, &isInitialCtxFailureSent, cause, &additionalCause)
...
func SendUEContextModificationResponse(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.UE_CONTEXT_MODIFICATION_RESPONSE, &isUECtxModificationRespSent, emptyCause, &additionalCause)
...
func SendUEContextModificationFailure(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.UE_CONTEXT_MODIFICATION_FAILURE, &isUECtxModificationFailureSent, cause, &additionalCause)
...
func SendUEContextReleaseComplete(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.UE_CONTEXT_RELEASE_COMPLETE, &isUECtxReleaseCompleteSent, emptyCause, &additionalCause)
...
func SendUEContextReleaseRequest(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.UE_CONTEXT_RELEASE_REQUEST, &isUECtxReleaseReqSent, cause, &additionalCause)
...
func SendInitialUEMessage(amf *n3iwf_context.N3IWFAMF,
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.INITIAL_UE_MESSAGE, &isInitialUEMessageSent, emptyCause, &additionalCause)
...
func SendUplinkNASTransport(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.UPLINK_NAS_TRANSPORT, &isUplinkNasTransportSent, emptyCause, &additionalCause)
...
func SendNASNonDeliveryIndication(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.NAS_NON_DELIVERY_INDICATION, &isNasNonDeliveryIndicationSent, cause, &additionalCause)
...
func SendPDUSessionResourceSetupResponse(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.PDUSESSION_RESOURCE_SETUP_RESPONSE, &isPduSessionResourceSetupRespSent, emptyCause, &additionalCause)
...
func SendPDUSessionResourceModifyResponse(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.PDUSESSION_RESOURCE_MODIFY_RESPONSE, &isPduSessionResourceModifyRespSent, emptyCause, &additionalCause)
...
func SendPDUSessionResourceModifyIndication(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.PDUSESSION_RESOURCE_MODIFY_INDICATION, &isPduSessionResourceModifyIndicationSent, emptyCause, &additionalCause)
...
func SendPDUSessionResourceNotify(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.PDUSESSION_RESOURCE_NOTIFY, &isPduSessionResourceNotifySent, emptyCause, &additionalCause)
...
func SendPDUSessionResourceReleaseResponse(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.PDUSESSION_RESOURCE_RELEASE_RESPONSE, &isPduSessionResourceReleaseRespSent, emptyCause, &additionalCause)
...
func SendErrorIndication(
	...
	if cause != nil {
		...
		defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.ERROR_INDICATION, &isErrorIndicationSent, emptyCause, &additionalCause)
	}
...
func SendErrorIndicationWithSctpConn(
	...
	additionalCause := ""
	if cause != nil {
		defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.ERROR_INDICATION_WITH_SCTP_CONN, &isErrorIndicationWithSctpConnSent, *cause, &additionalCause)
	} else {
		defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.ERROR_INDICATION_WITH_SCTP_CONN, &isErrorIndicationWithSctpConnSent, emptyCause, &additionalCause)
	}
...
func SendUERadioCapabilityCheckResponse(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.UE_RADIO_CAPABILITY_CHECK_RESPONSE, &isUeRadioCapabilityCheckRespSent, emptyCause, &additionalCause)
...
func SendAMFConfigurationUpdateAcknowledge(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.AMF_CONFIGURATION_UPDATE_ACKNOWLEDGE, &isAmfConfUpdateAckSent, emptyCause, &additionalCause)
...
func SendAMFConfigurationUpdateFailure(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.AMF_CONFIGURATION_UPDATE_FAILURE, &isAmfConfUpdateFailureSent, ngCause, &additionalCause)
...
func SendRANConfigurationUpdate(
	...
	additionalCause := ""
	defer ngap_metrics.IncrMetricsSentMsg(ngap_metrics.RAN_CONFIGURATION_UPDATE_UPDATE, &isRanConfUpdateSent, emptyCause, &additionalCause)
